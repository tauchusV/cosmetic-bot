...
async def subtype_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    examples = {
        ...
        "Бальзам/Кондиционер": "разгладить волосы, добавить блеск, облегчить расчёсывание",
        "Спрей/Сыворотка": "защитить от повреждений, увлажнить, добавить объём",
        "Укладка": "зафиксировать причёску, придать форму"
    }
